    ...
    return (
      ...
      <View style= {styles.container}> 
        <View style= {styles.containerHead}>
          ...
          <Text style={styles.textHead}>Luzon{'\n'}</Text>
        </View>
      
        <ScrollView style={{marginTop:-40, zIndex:1}}>
        <Image style={styles.ImageSize2} source={require('./img/maginhawa.jpg')} />
        <FlatButton text='Quezon City'  onPress={ () => navigation.navigate("Quezon City")} />

        
        <Image style={styles.ImageSize2} source={require('./img/pasig.jpg')} />
        <FlatButton text='Pasig City'   onPress={ () => navigation.navigate("Pasig City")} />

        <Image style={styles.ImageSize2} source={require('./img/valenzuela.jpg')} />
        <FlatButton text='Valenzuela City'   onPress={ () => navigation.navigate("Valenzuela City")} />
        </ScrollView>
      </View>
